...
void PlaneEvent::initWithRectEvent(RectRaiseFunc raiseFunc_, RectEventFunc eventFunc_,
                                                      const cocos2d::CCRect &hitRect_, const AtkData& atkData_)
{
    ...
    cbd.rectData.atkData = atkData_;
    m_conditionMap[RECT_EVENT] = false;
    m_callBackDataMap[RECT_EVENT] = cbd;
}

void PlaneEvent::initWithUnitEvent(UnitRaiseFunc raiseFunc_, UnitEventFunc eventFunc_,
